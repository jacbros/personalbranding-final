<?php
    // We will create a function that loads all of our CSS scripts
    function load_scripts() {
    // First parameter is the unique id or filename. Second parameter is the path to the file.
